...
/* renamed from: com.ss.android.ugc.aweme.ftc.components.audioeffect.a */
public final class C51969a {
    static {
        Covode.recordClassIndex(61341);
    }

    /* renamed from: a */
    public static final boolean m96692a(Effect effect) {
        String effectId;
        Integer e;
    ...
    /* renamed from: b */
    public static final String m96694b(Effect effect) {
        List<String> tags;
        Boolean bool;
        boolean z;
    ...
    /* renamed from: a */
    public static final boolean m96693a(Effect effect, String str) {
        List<String> tags;
