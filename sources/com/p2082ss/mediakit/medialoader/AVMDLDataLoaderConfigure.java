        ...
        try {
            if (this.mLiveContainerString != null) {
                ...
                if (!jSONObject.isNull("enable_mdl_proto")) {
                    ...
                    AVMDLLog.m147910w("ttmn", "mdl live json enable_mdl_proto:" + this.mLiveEnableMdlProto);
                }
            }
        } catch (Exception e) {
            AVMDLLog.m147906e("ttmn", "parse json config fail:" + e.toString());
        }
    }
    ...
    public void setCacheInfoList(String[] strArr, long[] jArr) {
        if (strArr.length != 0 && jArr.length != 0 && strArr.length == jArr.length) {
            ...
            if (TextUtils.isEmpty(this.mCacheDirListsStr)) {
                AVMDLLog.m147906e("AVMDLDataLoaderConfigure", "cache dir list str is null");
            } else {
                AVMDLLog.m147905d("AVMDLDataLoaderConfigure", "cache dir list str is:" + this.mCacheDirListsStr);
            }
        }
    }
