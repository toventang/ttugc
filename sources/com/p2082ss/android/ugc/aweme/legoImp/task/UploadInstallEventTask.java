...
public class UploadInstallEventTask implements AbstractC58264w {
    static {
    ...
    public final void mo28600a(Context context) {
        C51423a.m95787a("UploadInstallEventTask");
        if (C36145b.m73641b().mo63271c(context, "is_first_install")) {
            SecApiImpl.m119993a().reportData("install");
            C36145b.m73641b().mo63266a(context, "is_first_install", false);
        }
    }
}
