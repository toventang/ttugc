...
/* renamed from: com.ss.android.ugc.aweme.net.UserTypeAdapterFactory */
public class UserTypeAdapterFactory implements AbstractC28033w {
    static {
    ...
    public <T> AbstractC28031v<T> create(C27910f fVar, C27895a<T> aVar) {
        ...
        return new AbstractC28031v<T>() {
            /* class com.p2082ss.android.ugc.aweme.net.UserTypeAdapterFactory.C613021 */
            ...
            public final T read(C27897a aVar) {
                ...
                T t = (T) ((User) a.read(aVar));
                C80517gw.m139563a().mo123773a(t.getUid(), t.getSecUid());
                return t;
            }
