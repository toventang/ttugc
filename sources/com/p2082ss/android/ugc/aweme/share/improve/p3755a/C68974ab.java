...
public final class C68974ab implements AbstractC69693h {

    /* renamed from: a */
    private final Handler f154302a;
    ...
    static final class CallableC68975a<V> implements Callable {

        /* renamed from: a */
        public static final CallableC68975a f154303a = new CallableC68975a();
    ...
    public C68974ab(Handler handler) {
        C89219l.m154721d(handler, "");
        this.f154302a = handler;
    }
    ...
    public final void mo61915a(Context context, SharePackage sharePackage) {
        ...
        C34608n.m70658a().mo61083a(this.f154302a, CallableC68975a.f154303a, 53);
    }
}
