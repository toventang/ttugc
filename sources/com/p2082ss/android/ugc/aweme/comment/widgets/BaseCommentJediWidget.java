...
/* renamed from: com.ss.android.ugc.aweme.comment.widgets.BaseCommentJediWidget */
public abstract class BaseCommentJediWidget extends Widget implements AbstractC20527q, AbstractC33974au {
    static {
    ...
    /* renamed from: com.ss.android.ugc.aweme.comment.widgets.BaseCommentJediWidget$a */
    protected static final class C37301a<T extends View> {

        /* renamed from: a */
        public T f87975a;

        /* renamed from: b */
        public final int f87976b;

        static {
            Covode.recordClassIndex(44672);
        }

        public C37301a(int i) {
            this.f87976b = i;
        }

        /* renamed from: a */
        public final T mo64895a(BaseCommentJediWidget baseCommentJediWidget, AbstractC89286i<?> iVar) {
            C89219l.m154721d(baseCommentJediWidget, "");
            C89219l.m154721d(iVar, "");
            if (this.f87975a == null) {
                View view = baseCommentJediWidget.f56005e;
                if (view == null) {
                    C89219l.m154715b();
                }
                T t = (T) view.findViewById(this.f87976b);
                if (t == null) {
                    C89219l.m154715b();
                }
                this.f87975a = t;
    ...
    /* renamed from: a */
    protected static <T extends View> C37301a<T> m75294a(int i) {
        return new C37301a<>(i);
    }

    /* renamed from: a */
    protected static void m75295a(View... viewArr) {
