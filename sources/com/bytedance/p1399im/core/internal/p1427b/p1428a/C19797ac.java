...
public final class C19797ac extends AbstractC19927w {
    static {
    ...
    public final void mo31129a(C19978k kVar, Runnable runnable) {
        ...
        RunnableC19987d.m37729a(new AbstractC19986c<List<C19538ai>>() {
            /* class com.bytedance.p1399im.core.internal.p1427b.p1428a.C19797ac.C198003 */
            ...
            public List<C19538ai> mo31187a() {
                int i;
                C19598aw a;
                C19742b.m36974a("LoadHistoryHandler.saveMsg(String,List,boolean)");
                ...
                try {
                    ...
                    C19742b.m36975a("LoadHistoryHandler.saveMsg(String,List,boolean)", true);
                    Collections.sort(arrayList);
                } catch (Exception e) {
                    C19742b.m36975a("LoadHistoryHandler.saveMsg(String,List,boolean)", false);
                    C19512f.m36457b("imsdk", "LoadHistoryHandler saveMsg", e);
                    C19696b.m36814a(1, e);
                }
                return arrayList;
            }
        }, new AbstractC19985b<List<C19538ai>>() {
            /* class com.bytedance.p1399im.core.internal.p1427b.p1428a.C19797ac.C198014 */
            ...
            public final /* synthetic */ void mo31188a(List<C19538ai> list) {
                C20014q.m37816a().mo31908b(str, list);
            }
        }, C19983a.m37721c());
