...
/* renamed from: com.bytedance.ies.xbridge.i.d.c */
public final class C18627c {
    static {
        Covode.recordClassIndex(21321);
    }

    /* renamed from: a */
    public static String m34596a(Context context, Uri uri) {
        Uri uri2;
        MethodCollector.m26663i(3178);
        Uri uri3 = null;
        if (uri == null) {
            MethodCollector.m26664o(3178);
            return null;
        }
        ...
        if (TextUtils.isEmpty(scheme) || "file".equals(scheme)) {
            ...
            if (DocumentsContract.isDocumentUri(context, uri)) {
                if (TextUtils.equals("com.android.externalstorage.documents", uri.getAuthority())) {
                    ...
                    if (documentId == null || !documentId.startsWith("raw:")) {
                        ...
                        String a = m34597a(context, uri2, null, null);
                        if (a == null) {
                            try {
                    ...
                    String a2 = m34597a(context, uri3, "_id=?", new String[]{split2[1]});
                    MethodCollector.m26664o(3178);
                    return a2;
                }
            }
            if ("content".equals(scheme)) {
                ...
                if ("com.google.android.apps.photos.contentprovider".equals(uri.getAuthority())) {
                    ...
                    if (str3.startsWith("content")) {
                        String a3 = m34597a(context, Uri.parse(str3), null, null);
                        MethodCollector.m26664o(3178);
                        return a3;
                    }
                ...
                if (TextUtils.isEmpty(lastPathSegment) || !lastPathSegment.startsWith("/storage/emulated/")) {
                    ...
                    String a4 = m34597a(context, MediaStore.Images.Media.EXTERNAL_CONTENT_URI, "_id= ?", new String[]{lastPathSegment});
                    MethodCollector.m26664o(3178);
                    return a4;
                }
                MethodCollector.m26664o(3178);
            ...
            String a5 = m34597a(context, uri, null, null);
            MethodCollector.m26664o(3178);
            return a5;
        }
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0045, code lost:
        com.bytedance.frameworks.apm.trace.MethodCollector.m26664o(3272);
     */
    ...
    private static java.lang.String m34597a(android.content.Context r10, android.net.Uri r11, java.lang.String r12, java.lang.String[] r13) {
        /*
            r4 = 3272(0xcc8, float:4.585E-42)
        ...
        L_0x0045:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.ies.xbridge.p1317i.p1321d.C18627c.m34597a(android.content.Context, android.net.Uri, java.lang.String, java.lang.String[]):java.lang.String");
    }
}
