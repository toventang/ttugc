...
final class XXHash32JavaSafe extends XXHash32 {
    ...
    public final int hash(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i2 >= 16) {
            ...
            do {
                i7 = Integer.rotateLeft(i7 + (SafeUtils.readIntLE(bArr, i) * -2048144777), 13) * -1640531535;
                int i11 = i + 4;
        ...
        int i14 = i4 + i2;
        while (i <= i5 - 4) {
            i14 = Integer.rotateLeft(i14 + (SafeUtils.readIntLE(bArr, i) * -1028477379), 17) * 668265263;
            i += 4;
        }
        while (i < i5) {
            i14 = Integer.rotateLeft(i14 + ((SafeUtils.readByte(bArr, i) & 255) * 374761393), 11) * -1640531535;
            i++;
        }
