...
public final class C26354ef extends AbstractC26500jp {

    /* renamed from: a */
    final SSLSocketFactory f61875a = null;
    ...
    /* renamed from: e */
    public final boolean mo43177e() {
        mo43486B();
        try {
            NetworkInfo a = m51767a((ConnectivityManager) m51768a(mo43012m(), "connectivity"));
    ...
    public C26354ef(C26498jo joVar) {
        super(joVar);
        int i = Build.VERSION.SDK_INT;
    }

    /* renamed from: a */
    private static NetworkInfo m51767a(ConnectivityManager connectivityManager) {
        try {
    ...
    /* renamed from: a */
    static byte[] m51769a(HttpURLConnection httpURLConnection) {
        MethodCollector.m26663i(6586);
    ...
    /* renamed from: a */
    private static Object m51768a(Context context, String str) {
        Object obj;
        MethodCollector.m26663i(6444);
