...
public final class C61758b extends AbstractC61760c {
    static {
        Covode.recordClassIndex(72491);
    }

    /* renamed from: com.ss.android.ugc.aweme.notification.a.b$a */
    public static final class C61759a implements AbstractC61766f {

        /* renamed from: a */
        final /* synthetic */ C61758b f140147a;
        ...
        public final String mo99866a() {
            String string = C17867d.m33078a().getString(R.string.diw);
            C89219l.m154716b(string, "");
            return string;
        }

        /* JADX WARN: Incorrect args count in method signature: ()V */
        C61759a(C61758b bVar) {
            this.f140147a = bVar;
        }
        ...
        public final RecyclerView.ViewHolder mo99865a(ViewGroup viewGroup) {
            ...
            C89219l.m154716b(a, "");
            return new View$OnClickListenerC61769h(a, this.f140147a.mo99872b());
        }
        ...
        public final void mo99868a(RecyclerView.ViewHolder viewHolder, BaseNotice baseNotice, int i, HashMap<String, BaseNotice> hashMap) {
            ...
            if (viewHolder instanceof View$OnClickListenerC61769h) {
                ((View$OnClickListenerC61769h) viewHolder).mo99878a(baseNotice);
            }
        }
    }
