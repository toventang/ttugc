...
import com.p2082ss.bduploader.net.BDVNetClient;
import java.lang.reflect.Method;
import org.json.JSONArray;
import org.json.JSONObject;

/* renamed from: com.ss.bduploader.net.HTTPDNS */
public class HTTPDNS extends BaseDNS {
    ...
    public void start() {
        ...
        for (Method method : declaredMethods) {
            if (method.getName().equals("startTask") && method.getParameterTypes().length == 5) {
                this.mNetClient.startTask(_getURL, null, null, 0, new BDVNetClient.CompletionListener() {
                    /* class com.p2082ss.bduploader.net.HTTPDNS.C860681 */

                    static {
                        Covode.recordClassIndex(100833);
                    }

                    @Override // com.p2082ss.bduploader.net.BDVNetClient.CompletionListener
        ...
        this.mNetClient.startTask(_getURL, null, new BDVNetClient.CompletionListener() {
            /* class com.p2082ss.bduploader.net.HTTPDNS.C860692 */
    ...
    private BDUploadDNSInfo parserResult(JSONObject jSONObject) {
        ...
        if (i == 2 || i == 1) {
            ...
            if (optJSONArray == null || optJSONArray.length() == 0) {
                BDUploadLog.m147836d("HTTPDNS", C1764a.m5928a("no ips in json, type:%d", new Object[]{Integer.valueOf(this.mHttpDNSType)}));
                return null;
            }
        ...
        return new BDUploadDNSInfo(this.mHttpDNSType, this.mHostname, str2, j, this.mId);
    }

    public static void setDNSServerHost(String str, String str2) {
        MethodCollector.m26663i(6245);
        synchronized (HTTPDNS.class) {
            try {
                ...
                MethodCollector.m26664o(6245);
            }
        }
    }

    public void _handleResponse(JSONObject jSONObject, Error error) {
        BDUploadLog.m147836d("HTTPDNS", C1764a.m5928a("****http dns id:%s", new Object[]{this.mId}));
        ...
        if (error != null) {
            ...
            BDUploadLog.m147836d("HTTPDNS", C1764a.m5928a("http dns json is empty type:%d", new Object[]{Integer.valueOf(this.mHttpDNSType)}));
        } else {
