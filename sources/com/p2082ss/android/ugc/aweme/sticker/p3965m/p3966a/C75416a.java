...
/* renamed from: com.ss.android.ugc.aweme.sticker.m.a.a */
public final class C75416a implements AbstractC75615a {

    /* renamed from: a */
    private final ShortVideoContext f169497a;

    static {
        Covode.recordClassIndex(88335);
    }

    public C75416a(ShortVideoContext shortVideoContext) {
        C89219l.m154721d(shortVideoContext, "");
        this.f169497a = shortVideoContext;
    }
    ...
    public final void mo118957a(Effect effect, String str, String str2, String str3) {
        ...
        ShortVideoContext shortVideoContext = this.f169497a;
        C89378p[] pVarArr = new C89378p[4];
        pVarArr[0] = C89387v.m154943a("video_source", str);
        if (str2 == null) {
            str2 = "";
        }
