...
/* renamed from: com.ss.android.ugc.aweme.services.mvtemplate.AVVideoViewComponentFactoryImplKt$toOnUIPlayListener$1 */
public final class AVVideoViewComponentFactoryImplKt$toOnUIPlayListener$1 implements OnUIPlayListener {
    final /* synthetic */ AbstractC78931c $outer;
    ...
    AVVideoViewComponentFactoryImplKt$toOnUIPlayListener$1(AbstractC78931c cVar) {
        this.$outer = cVar;
    }

    @Override // com.p2082ss.android.ugc.aweme.player.sdk.api.OnUIPlayListener
    public final void onResumePlay(String str) {
        this.$outer.mo122740b();
    }

    @Override // com.p2082ss.android.ugc.aweme.player.sdk.api.OnUIPlayListener
    public final void onPlayFailed(C84208l lVar) {
        AbstractC78931c cVar = this.$outer;
        if (lVar != null) {
