...
/* renamed from: com.ss.bduploader.net.LocalDNS */
public class LocalDNS extends BaseDNS {
    ...
    @Override // com.p2082ss.bduploader.net.BaseDNS
    ...
    public void start() {
        try {
            this.mFuture = BDUploadThreadPool.addExecuteTask(new Runnable() {
                /* class com.p2082ss.bduploader.net.LocalDNS.RunnableC860701 */
                ...
                public void run() {
                    BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("----call local dns, host:%s", new Object[]{LocalDNS.this.mHostname}));
                    try {
                        ...
                        if (LocalDNS.this.mAddress == null) {
                            BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("****end call local dns, not get address host:%s", new Object[]{LocalDNS.this.mHostname}));
                        ...
                        if (TextUtils.isEmpty(str)) {
                            BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("****end call local dns, iplist null host:%s", new Object[]{LocalDNS.this.mHostname}));
                            LocalDNS.this.notifyError(new BDUploadDNSInfo(0, LocalDNS.this.mHostname, null, 0, LocalDNS.this.mId));
                            return;
                        }
                        BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("****end call local dns, suc iplist:%s host:%s", new Object[]{str, LocalDNS.this.mHostname}));
                        ...
                        LocalDNS.this.mRet = true;
                        BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("****end call local dns, end exception:%s host:%s", new Object[]{th, LocalDNS.this.mHostname}));
                        LocalDNS.this.notifyError(new BDUploadDNSInfo(0, LocalDNS.this.mHostname, null, 0, LocalDNS.this.mId));
                    }
                }
            });
        } catch (Exception e) {
            BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("****end call local dns, exception:%s host:%s", new Object[]{e, this.mHostname}));
            notifyError(new BDUploadDNSInfo(0, this.mHostname, null, 0, this.mId));
        }
        this.mHandler.postDelayed(new MyRunnable(this), 10000);
    }

    /* renamed from: com.ss.bduploader.net.LocalDNS$MyRunnable */
    static class MyRunnable implements Runnable {
        ...
        public void run() {
            BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("----implement delayed check for local dns", new Object[0]));
            LocalDNS localDNS = this.mLocalDNSRef.get();
            if (localDNS == null) {
                BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("****end implement delayed check for local dns, dns object null", new Object[0]));
            } else if (!localDNS.mRet) {
                localDNS.cancel();
                BDUploadLog.m147836d("LocalDNS", C1764a.m5928a("****end implement delayed check cancel local dns,", new Object[0]));
