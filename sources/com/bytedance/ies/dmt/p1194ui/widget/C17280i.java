...
/* renamed from: com.bytedance.ies.dmt.ui.widget.i */
public final class C17280i {

    /* renamed from: a */
    public float[] f41401a = new float[8];

    /* renamed from: b */
    public Path f41402b;

    /* renamed from: c */
    public Paint f41403c;
    ...
    /* renamed from: j */
    public Region f41410j;

    /* renamed from: k */
    public RectF f41411k;
    ...
    /* renamed from: a */
    public final void mo27477a(View view) {
        float width;
        C89219l.m154721d(view, "");
        RectF rectF = this.f41411k;
        if (rectF == null) {
            C89219l.m154710a("mLayer");
        }
        int width2 = (int) rectF.width();
        RectF rectF2 = this.f41411k;
        if (rectF2 == null) {
            C89219l.m154710a("mLayer");
        }
        ...
        if (this.f41404d) {
            ...
            if (Build.VERSION.SDK_INT <= 27) {
                Path path2 = this.f41402b;
                if (path2 == null) {
                    C89219l.m154710a("mClipPath");
                }
                path2.addCircle(pointF.x, pointF.y, f3, Path.Direction.CW);
                Path path3 = this.f41402b;
                if (path3 == null) {
                    C89219l.m154710a("mClipPath");
                }
                path3.moveTo(0.0f, 0.0f);
                Path path4 = this.f41402b;
                if (path4 == null) {
                    C89219l.m154710a("mClipPath");
                }
                path4.moveTo(f, f2);
                ...
                float f6 = f5 - f3;
                Path path5 = this.f41402b;
                if (path5 == null) {
                    C89219l.m154710a("mClipPath");
                }
                path5.moveTo(rectF3.left, f6);
                Path path6 = this.f41402b;
                if (path6 == null) {
                    C89219l.m154710a("mClipPath");
                }
            ...
            Path path7 = this.f41402b;
            if (path7 == null) {
                C89219l.m154710a("mClipPath");
            }
            path7.addRoundRect(rectF3, this.f41401a, Path.Direction.CW);
        }
        Region region = new Region((int) rectF3.left, (int) rectF3.top, (int) rectF3.right, (int) rectF3.bottom);
        Region region2 = this.f41410j;
        if (region2 == null) {
            C89219l.m154710a("mAreaRegion");
        }
        Path path8 = this.f41402b;
        if (path8 == null) {
            C89219l.m154710a("mClipPath");
        }
