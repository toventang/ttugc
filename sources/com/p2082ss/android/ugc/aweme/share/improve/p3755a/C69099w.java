...
public final class C69099w implements AbstractC69693h {

    /* renamed from: a */
    public final C18288a f154537a;

    /* renamed from: b */
    private final LiveEvent f154538b;
    ...
    public C69099w(LiveEvent liveEvent, C18288a aVar) {
        C89219l.m154721d(liveEvent, "");
        this.f154538b = liveEvent;
        this.f154537a = aVar;
    }
    ...
    public final void mo61915a(Context context, SharePackage sharePackage) {
        ...
        this.f154538b.getEventID();
        JSONObject jSONObject = new JSONObject();
        jSONObject.put(StringSet.type, "edit");
        C18288a aVar = this.f154537a;
        if (aVar != null) {
