...
/* renamed from: com.ss.android.ugc.aweme.compliance.privacy.settings.account.pages.suggestaccount.SugToFbFriendsViewModel */
public final class SugToFbFriendsViewModel extends BasePrivacyUserSettingViewModel implements AbstractC90253j {
    static {
    ...
    public final AbstractC88979t<BaseResponse> mo69142b(int i) {
        return C39727a.m80621c("to_fb_friends", i);
    }
    ...
    public final Integer mo69143a(C39258q qVar) {
        ...
        if (tVar != null) {
            return Integer.valueOf(tVar.f92753b);
        }
        return null;
    }
