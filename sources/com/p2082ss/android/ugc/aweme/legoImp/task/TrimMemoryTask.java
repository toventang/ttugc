...
public class TrimMemoryTask implements AbstractC58264w {

    /* renamed from: a */
    private int f132991a;
    ...
    public final void mo28600a(Context context) {
        if (!((Boolean) C58179c.f132486k.getValue()).booleanValue() || C58140b.m105076b() || this.f132991a >= 40) {
            C51423a.m95787a("TrimMemoryTask");
            C80569id.m139662a(this.f132991a);
        }
    }
}
