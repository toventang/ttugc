...
public final class C1774ah implements AbstractC1876e {
    static {
    ...
    public final View mo5574a(Context context, ViewGroup viewGroup, boolean z) {
        ...
        newUserFeedProgressBar.setId(R.id.cs4);
        ViewGroup.LayoutParams a4 = C0174a.m576a(loadMoreFrameLayout, -1, -2);
        C0174a.m578a(newUserFeedProgressBar);
        if (newUserFeedProgressBar.getParent() == null) {
            loadMoreFrameLayout.addView(newUserFeedProgressBar, a4);
        }
        View videoDownloadStatusBar = new VideoDownloadStatusBar(context);
        videoDownloadStatusBar.setId(R.id.aod);
        ViewGroup.LayoutParams a5 = C0174a.m576a(loadMoreFrameLayout, -1, -2);
        C0174a.m578a(videoDownloadStatusBar);
        if (videoDownloadStatusBar.getParent() == null) {
            loadMoreFrameLayout.addView(videoDownloadStatusBar, a5);
        }
        ViewStub viewStub = new ViewStub(context);
        viewStub.setId(R.id.i2);
        viewStub.setInflatedId(R.id.i1);
        ...
        if (viewStub.getParent() == null) {
            loadMoreFrameLayout.addView(viewStub, a6);
        }
