...
import com.bytedance.apm.agent.instrumentation.p756io.CountingInputStream;
import com.bytedance.apm.agent.instrumentation.p756io.CountingOutputStream;
import com.bytedance.apm.agent.instrumentation.p756io.StreamCompleteEvent;
import com.bytedance.apm.agent.instrumentation.p756io.StreamCompleteListener;
...
public class HttpsURLConnectionExtension extends HttpsURLConnection {
    ...
    public OutputStream getOutputStream() {
        ...
        try {
            ...
            countingOutputStream.addStreamCompleteListener(new StreamCompleteListener() {
                /* class com.bytedance.apm.agent.instrumentation.HttpsURLConnectionExtension.C122752 */

                static {
                    Covode.recordClassIndex(14029);
                }

                @Override // com.bytedance.apm.agent.instrumentation.p756io.StreamCompleteListener
    ...
    public InputStream getInputStream() {
        ...
        try {
            ...
            countingInputStream.addStreamCompleteListener(new StreamCompleteListener() {
                /* class com.bytedance.apm.agent.instrumentation.HttpsURLConnectionExtension.C122741 */
    ...
    public void addTransactionAndErrorData(TransactionState transactionState2) {
        ...
        if (C12397c.m22288e()) {
            ...
            String str = "addTransactionAndErrorData: " + end.toString();
        }
    }
