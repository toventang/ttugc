...
import com.p2082ss.android.ugc.aweme.shortvideo.cut.scene.C70333n;
...
public final class C73130f extends AbstractC82005a implements AbstractC20382b {

    /* renamed from: f */
    public VECutVideoPresenter f164213f;

    /* renamed from: g */
    public AbstractC70297bs f164214g;

    /* renamed from: h */
    private VideoEditViewModel f164215h;

    /* renamed from: i */
    private CutVideoPreviewViewModel f164216i;

    /* renamed from: j */
    private final AbstractC89244h f164217j = C89250i.m154773a((AbstractC89171a) new C73132b(this));

    /* renamed from: k */
    private final AbstractC89244h f164218k = C89250i.m154773a((AbstractC89171a) new C73131a(this));

    /* renamed from: l */
    private final AbstractC89244h f164219l = C89250i.m154773a((AbstractC89171a) new C73133c(this));
    ...
    /* renamed from: E */
    public final C73126d mo62771E() {
        return (C73126d) this.f164218k.getValue();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: F */
    public final C70333n mo115683F() {
        return (C70333n) this.f164219l.getValue();
    }
    ...
    static final class C73132b extends AbstractC89220m implements AbstractC89171a<C82092c> {

        /* renamed from: a */
        final /* synthetic */ C73130f f164221a;
        ...
        public final /* synthetic */ C82092c invoke() {
            ...
            this.f164221a.mo36387a(R.id.e9r, cVar, "EditCornerScene");
            return cVar;
        }
    }

    /* renamed from: G */
    public final AbstractC70527h mo115684G() {
        return mo115683F().mo110956b();
    }

    /* renamed from: com.ss.android.ugc.aweme.shortvideo.stitch.f$c */
    static final class C73133c extends AbstractC89220m implements AbstractC89171a<C70333n> {

        /* renamed from: a */
        final /* synthetic */ C73130f f164222a;
        ...
        public final /* synthetic */ C70333n invoke() {
            C70333n nVar = new C70333n(false, false);
            VECutVideoPresenter vECutVideoPresenter = this.f164222a.f164213f;
            if (vECutVideoPresenter == null) {
                C89219l.m154710a("presenter");
            }
            nVar.mo110954a(vECutVideoPresenter);
            this.f164222a.mo36387a(R.id.e9r, nVar, "CutVideoEditScene");
            return nVar;
        }
    }

    /* renamed from: com.ss.android.ugc.aweme.shortvideo.stitch.f$a */
    static final class C73131a extends AbstractC89220m implements AbstractC89171a<C73126d> {

        /* renamed from: a */
        final /* synthetic */ C73130f f164220a;
        ...
        /* Return type fixed from 'java.lang.Object' to match base method */
        @Override // p4600h.p4611f.p4612a.AbstractC89171a
        public final /* synthetic */ C73126d invoke() {
            C73126d dVar = new C73126d();
            AbstractC70297bs bsVar = this.f164220a.f164214g;
            if (bsVar == null) {
                C89219l.m154710a("previewEditCallback");
            }
            C89219l.m154721d(bsVar, "");
            dVar.f164208a = bsVar;
            this.f164220a.mo36387a(R.id.e9r, dVar, "StitchTrimmingBottomBarScene");
            return dVar;
        }
    }
    ...
    public final void mo22704a(Bundle bundle) {
        ...
        C89219l.m154716b(a, "");
        this.f164215h = (VideoEditViewModel) a;
        ...
        C89219l.m154716b(a2, "");
        this.f164216i = (CutVideoPreviewViewModel) a2;
        View view = mo62771E().f52550n;
        C89219l.m154716b(view, "");
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        Objects.requireNonNull(layoutParams, "null cannot be cast to non-null type android.widget.FrameLayout.LayoutParams");
        FrameLayout.LayoutParams layoutParams2 = (FrameLayout.LayoutParams) layoutParams;
        layoutParams2.gravity = 80;
        View view2 = mo62771E().f52550n;
        C89219l.m154716b(view2, "");
        view2.setLayoutParams(layoutParams2);
        View view3 = mo115683F().f52550n;
        C89219l.m154716b(view3, "");
        ViewGroup.LayoutParams layoutParams3 = view3.getLayoutParams();
        Objects.requireNonNull(layoutParams3, "null cannot be cast to non-null type android.widget.FrameLayout.LayoutParams");
        FrameLayout.LayoutParams layoutParams4 = (FrameLayout.LayoutParams) layoutParams3;
        layoutParams4.gravity = 80;
        View view4 = mo115683F().f52550n;
    ...
    public final ViewGroup mo36393b(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        View a = C1764a.m5927a(layoutInflater, R.layout.atj, viewGroup, false);
    ...
    public final void mo36473a(View view, Bundle bundle) {
        ...
        mo36417e((C82092c) this.f164217j.getValue());
        mo36417e(mo62771E());
        mo36417e(mo115683F());
    }
