...
public class ConsumeProductState extends AbstractC15131a {

    /* renamed from: c */
    public final String f37152c = ConsumeProductState.class.getCanonicalName();
    ...
    public final EnumC15121a mo24396a() {
        return EnumC15121a.Consume;
    }

    public ConsumeProductState(AbstractC15153d dVar) {
        super(dVar);
    }
    ...
    class ChannelPayConsumeFinishedListener implements ConsumeIapProductListener {
        ...
        public void onConsumeFinished(AbsResult absResult) {
            ...
            if (code == 0) {
                ...
                PaymentServiceManager.get().getGoogleIapExternalService().getPayloadPreferencesService().removePayload(C15253a.m28071a().mo24709i().mo24713b(), ConsumeProductState.this.f36941a.getOrderId());
                ConsumeProductState.this.f36941a.setConsumed(true);
                if (ConsumeProductState.this.f36941a.isSuccess() && !ConsumeProductState.this.f36941a.isFinished()) {
                    ConsumeProductState.this.mo24397a(new C15126d(0, 0, "pay success in ChannelPayConsumeFinishedListener"));
                    return;
                }
                return;
            }
            C15253a.m28071a().mo24705e();
            C15126d dVar = new C15126d(207, code, "google consume product fail in ChannelPayConsumeFinishedListener: " + absResult.getMessage());
            this.mConsumeProductMonitor.mo24374a(false, dVar);
            ConsumeProductState.this.mo24397a(dVar);
        }
