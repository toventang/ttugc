...
/* renamed from: com.ss.android.ugc.aweme.base.arch.b */
public abstract class AbstractC34488b extends AbstractC34586a implements AbstractC20380ar<C34499i>, AbstractC20527q {

    /* renamed from: a */
    public C34499i f81473a = new C34499i();

    /* renamed from: b */
    private HashMap f81474b;
    ...
    public View mo60929a(int i) {
        if (this.f81474b == null) {
            this.f81474b = new HashMap();
        }
        View view = (View) this.f81474b.get(Integer.valueOf(i));
        if (view != null) {
            return view;
        }
        View view2 = getView();
        ...
        this.f81474b.put(Integer.valueOf(i), findViewById);
        return findViewById;
    }

    /* renamed from: a */
    public void mo60930a() {
        HashMap hashMap = this.f81474b;
        if (hashMap != null) {
            hashMap.clear();
        }
    }
