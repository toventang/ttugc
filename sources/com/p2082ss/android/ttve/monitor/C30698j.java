...
public final class C30698j {

    /* renamed from: a */
    private static final Set<String> f73428a;

    /* renamed from: b */
    private static final Set<String> f73429b;

    /* renamed from: c */
    private static final Set<String> f73430c;

    /* renamed from: d */
    private static final Set<String> f73431d;
    ...
    /* renamed from: a */
    public static int m63081a(String str) {
        if (f73428a.contains(str)) {
            return 1;
        }
        if (f73431d.contains(str)) {
            return 3;
        }
        if (f73429b.contains(str)) {
            return 2;
        }
        return 0;
    }
