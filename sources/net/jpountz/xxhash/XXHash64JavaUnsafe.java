...
final class XXHash64JavaUnsafe extends XXHash64 {
    ...
    public final long hash(byte[] bArr, int i, int i2, long j) {
        long j2;
        int i3 = i;
        UnsafeUtils.checkRange(bArr, i3, i2);
        int i4 = i3 + i2;
        long j3 = -4417276706812531889L;
        if (i2 >= 32) {
            int i5 = i4 - 32;
            ...
            long j7 = j - -7046029288634856825L;
            while (true) {
                j4 = Long.rotateLeft(j4 + (UnsafeUtils.readLongLE(bArr, i3) * j3), 31) * -7046029288634856825L;
                int i6 = i3 + 8;
                j5 = Long.rotateLeft(j5 + (UnsafeUtils.readLongLE(bArr, i6) * j3), 31) * -7046029288634856825L;
                int i7 = i6 + 8;
                j6 = Long.rotateLeft(j6 + (UnsafeUtils.readLongLE(bArr, i7) * j3), 31) * -7046029288634856825L;
                int i8 = i7 + 8;
                j7 = Long.rotateLeft(j7 + (UnsafeUtils.readLongLE(bArr, i8) * -4417276706812531889L), 31) * -7046029288634856825L;
                i3 = i8 + 8;
                if (i3 > i5) {
                    break;
                }
        ...
        long j8 = j2 + ((long) i2);
        while (i3 <= i4 - 8) {
            j8 = (Long.rotateLeft(j8 ^ (Long.rotateLeft(UnsafeUtils.readLongLE(bArr, i3) * -4417276706812531889L, 31) * -7046029288634856825L), 27) * -7046029288634856825L) - 8796714831421723037L;
            i3 += 8;
        }
        if (i3 <= i4 - 4) {
            j8 = (Long.rotateLeft(j8 ^ ((((long) UnsafeUtils.readIntLE(bArr, i3)) & 4294967295L) * -7046029288634856825L), 23) * -4417276706812531889L) + 1609587929392839161L;
            i3 += 4;
        }
        while (i3 < i4) {
            j8 = Long.rotateLeft(j8 ^ (((long) (UnsafeUtils.readByte(bArr, i3) & 255)) * 2870177450012600261L), 11) * -7046029288634856825L;
            i3++;
        }
