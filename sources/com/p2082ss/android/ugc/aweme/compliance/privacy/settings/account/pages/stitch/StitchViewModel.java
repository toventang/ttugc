...
/* renamed from: com.ss.android.ugc.aweme.compliance.privacy.settings.account.pages.stitch.StitchViewModel */
public final class StitchViewModel extends BasePrivacyUserSettingViewModel implements AbstractC90253j {
    static {
    ...
    public final AbstractC88979t<BaseResponse> mo69142b(int i) {
        return C39727a.m80619a("stitch", i);
    }
    ...
    public final Integer mo69143a(C39258q qVar) {
        ...
        if (gVar != null) {
            return Integer.valueOf(gVar.f92703c);
        }
        return null;
    }
