...
public final class C0249k {
    ...
    /* renamed from: a */
    public final void mo604a(long j, double d, double d2) {
        ...
        if (sin3 >= 1.0d) {
            ...
            Double.isNaN(acos);
            this.f753a = Math.round((sin2 + acos) * 8.64E7d) + 946728000000L;
            Double.isNaN(acos);
            long round2 = Math.round((sin2 - acos) * 8.64E7d) + 946728000000L;
            this.f754b = round2;
            if (round2 >= j || this.f753a <= j) {
                this.f755c = 1;
            } else {
                this.f755c = 0;
            }
