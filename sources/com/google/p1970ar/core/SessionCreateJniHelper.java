...
class SessionCreateJniHelper {
    ...
    static int getMinApkVersion(Context context) {
        try {
            Bundle bundle = m53844a(context.getPackageManager(), context.getPackageName()).metaData;
    ...
    static boolean checkApkSignature(Context context) {
        try {
            ...
            for (Signature signature2 : signatureArr) {
                ...
                String.valueOf(charsString).length();
                String.valueOf(charsString2).length();
            }
            return m53844a(context.getPackageManager(), context.getPackageName()).metaData.getBoolean("com.google.ar.core.disable_security_check", false);
        } catch (PackageManager.NameNotFoundException unused) {
            return true;
        }
    }
    ...
    /* renamed from: a */
    private static ApplicationInfo m53844a(PackageManager packageManager, String str) {
