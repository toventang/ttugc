...
/* renamed from: com.ss.android.ugc.aweme.kids.setting.n */
public final class C57981n implements AbstractC57982o {

    /* renamed from: a */
    private final Activity f132161a;
    ...
    public C57981n(Activity activity) {
        C89219l.m154721d(activity, "");
        this.f132161a = activity;
    }
    ...
    public final CommonItemView mo95126a(View view) {
        ...
        CommonItemView commonItemView = (CommonItemView) view.findViewById(R.id.dtm);
    ...
    public final void mo95128a(CommonItemView commonItemView) {
        ...
        SmartRouter.buildRoute(this.f132161a, "aweme://children/setting/security").open();
    }
