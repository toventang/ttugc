...
/* renamed from: com.ss.android.ugc.aweme.specact.popup.b.g */
public final class DialogC75162g extends DialogC81459o {
    static {
        Covode.recordClassIndex(88038);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DialogC75162g(final Context context, final C75124i iVar) {
        ...
        setOnKeyListener(DialogInterface$OnKeyListenerC751631.f169006a);
        ...
        if (str.length() > 0) {
            ((TuxTextView) findViewById(R.id.button)).setOnClickListener(new View.OnClickListener(this) {
                /* class com.p2082ss.android.ugc.aweme.specact.popup.p3943b.DialogC75162g.View$OnClickListenerC751642 */

                /* renamed from: a */
                final /* synthetic */ DialogC75162g f169007a;
                ...
                public final void onClick(View view) {
                    ...
                    C39162r.m79460a("referral_guid_pop_click", new C33744d().mo59983a("position", "feed").mo59983a("button_name", "ok").f79943a);
                    SpecActRedPacketApi.C75139a.m131891a(iVar, "False");
                    this.f169007a.dismiss();
                }
            });
        }
        ((TuxIconView) findViewById(R.id.a6t)).setOnClickListener(new View.OnClickListener(this) {
            /* class com.p2082ss.android.ugc.aweme.specact.popup.p3943b.DialogC75162g.View$OnClickListenerC751653 */

            /* renamed from: a */
            final /* synthetic */ DialogC75162g f169011a;
            ...
            public final void onClick(View view) {
                ClickAgent.onClick(view);
                C39162r.m79460a("referral_guid_pop_click", new C33744d().mo59983a("position", "feed").mo59983a("button_name", "close").f79943a);
                SpecActRedPacketApi.C75139a.m131891a(iVar, "True");
                this.f169011a.dismiss();
            }
        });
        C39162r.m79460a("referral_guid_pop_show", new C33744d().mo59983a("position", "feed").f79943a);
    }
}
