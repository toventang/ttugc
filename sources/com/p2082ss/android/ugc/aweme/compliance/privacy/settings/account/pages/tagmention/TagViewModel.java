...
/* renamed from: com.ss.android.ugc.aweme.compliance.privacy.settings.account.pages.tagmention.TagViewModel */
public final class TagViewModel extends BasePrivacyUserSettingViewModel implements AbstractC90253j {
    static {
    ...
    public final Integer mo69143a(C39258q qVar) {
        ...
        if (fVar != null) {
            return Integer.valueOf(fVar.f92698c);
        }
        return null;
    }
    ...
    public final void mo69141a(int i, BaseResponse baseResponse) {
        ...
        C39162r.m79460a("change_tag_permission", new C33744d().mo59983a("enter_from", "privacy_and_safety_settings").mo59983a("to_status", C39745b.C39748c.m80628a(i)).f79943a);
    }
}
