...
public final class MessagesInConversationRequestBody extends Message<MessagesInConversationRequestBody, Builder> {
    ...
    static final class ProtoAdapter_MessagesInConversationRequestBody extends ProtoAdapter<MessagesInConversationRequestBody> {
        ...
        /* JADX WARN: Type inference failed for: r0v0, types: [com.bytedance.im.core.proto.MessagesInConversationRequestBody$Builder, com.squareup.wire.Message$Builder] */
        /* JADX WARNING: Unknown variable types count: 1 */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final com.bytedance.p1399im.core.proto.MessagesInConversationRequestBody redact(com.bytedance.p1399im.core.proto.MessagesInConversationRequestBody r2) {
            /*
                r1 = this;
                com.bytedance.im.core.proto.MessagesInConversationRequestBody$Builder r0 = r2.newBuilder()
                r0.clearUnknownFields()
                com.bytedance.im.core.proto.MessagesInConversationRequestBody r0 = r0.build()
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bytedance.p1399im.core.proto.MessagesInConversationRequestBody.ProtoAdapter_MessagesInConversationRequestBody.redact(com.bytedance.im.core.proto.MessagesInConversationRequestBody):com.bytedance.im.core.proto.MessagesInConversationRequestBody");
        }
        ...
        public final MessagesInConversationRequestBody decode(ProtoReader protoReader) {
    ...
    public static final class Builder extends Message.Builder<MessagesInConversationRequestBody, Builder> {
        ...
        public final MessagesInConversationRequestBody build() {
            return new MessagesInConversationRequestBody(this.conversation_id, this.conversation_type, this.conversation_short_id, this.direction, this.anchor_index, this.limit, super.buildUnknownFields());
        }
    ...
    public final String toString() {
        return "MessagesInConversationRequestBody" + C19999h.f47538a.mo46674b(this).toString();
    }
    ...
    /* Return type fixed from 'com.bytedance.im.core.proto.MessagesInConversationRequestBody$Builder' to match base method */
    @Override // com.squareup.wire.Message
    public final Message.Builder<MessagesInConversationRequestBody, Builder> newBuilder() {
        Builder builder = new Builder();
    ...
    public MessagesInConversationRequestBody(String str, Integer num, Long l, MessageDirection messageDirection, Long l2, Integer num2, C89427i iVar) {
        super(ADAPTER, iVar);
        this.conversation_id = str;
        this.conversation_type = num;
        this.conversation_short_id = l;
