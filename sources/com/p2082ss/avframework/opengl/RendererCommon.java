...
public class RendererCommon {
    ...
    /* renamed from: com.ss.avframework.opengl.RendererCommon$1 */
    public static /* synthetic */ class C860321 {
        ...
        static {
            /*
                r0 = 100668(0x1893c, float:1.41066E-40)
                com.bytedance.covode.number.Covode.recordClassIndex(r0)
                com.ss.avframework.opengl.RendererCommon$ScalingType[] r0 = com.p2082ss.avframework.opengl.RendererCommon.ScalingType.values()
                int r0 = r0.length
                int[] r2 = new int[r0]
                com.p2082ss.avframework.opengl.RendererCommon.C860321.$SwitchMap$com$ss$avframework$opengl$RendererCommon$ScalingType = r2
                com.ss.avframework.opengl.RendererCommon$ScalingType r0 = com.p2082ss.avframework.opengl.RendererCommon.ScalingType.SCALE_ASPECT_FIT     // Catch:{ NoSuchFieldError -> 0x0018 }
                int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0018 }
                r0 = 1
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0018 }
            L_0x0018:
                int[] r2 = com.p2082ss.avframework.opengl.RendererCommon.C860321.$SwitchMap$com$ss$avframework$opengl$RendererCommon$ScalingType     // Catch:{ NoSuchFieldError -> 0x0023 }
                com.ss.avframework.opengl.RendererCommon$ScalingType r0 = com.p2082ss.avframework.opengl.RendererCommon.ScalingType.SCALE_ASPECT_FILL     // Catch:{ NoSuchFieldError -> 0x0023 }
                int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0023 }
                r0 = 2
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0023 }
            L_0x0023:
                int[] r2 = com.p2082ss.avframework.opengl.RendererCommon.C860321.$SwitchMap$com$ss$avframework$opengl$RendererCommon$ScalingType     // Catch:{ NoSuchFieldError -> 0x002e }
                com.ss.avframework.opengl.RendererCommon$ScalingType r0 = com.p2082ss.avframework.opengl.RendererCommon.ScalingType.SCALE_ASPECT_BALANCED     // Catch:{ NoSuchFieldError -> 0x002e }
            ...
            L_0x002e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.p2082ss.avframework.opengl.RendererCommon.C860321.<clinit>():void");
        }
    }
    ...
    private static float convertScalingTypeToVisibleFraction(ScalingType scalingType) {
        int i = C860321.$SwitchMap$com$ss$avframework$opengl$RendererCommon$ScalingType[scalingType.ordinal()];
        if (i == 1) {
            return 1.0f;
        }
        if (i == 2) {
    ...
    public static void calcWindRatio(boolean z, boolean z2, boolean z3, int i, int i2, int i3, int i4, float[] fArr) {
        float f;
        float f2;
        float f3;
        ...
        android.opengl.Matrix.scaleM(fArr, 0, f * f3, 1.0f, 1.0f);
        if (!z3) {
            f6 = 1.0f;
        }
        android.opengl.Matrix.scaleM(fArr, 0, 1.0f, f2 * f6, 1.0f);
    }
}
