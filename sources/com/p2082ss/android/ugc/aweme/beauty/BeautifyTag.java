...
public final class BeautifyTag {
    ...
    public final int hashCode() {
        String str = this.tag;
        return ((str != null ? str.hashCode() : 0) * 31) + m71105x6db40147(this.value);
    }
    ...
    /* renamed from: com_ss_android_ugc_aweme_beauty_BeautifyTag_com_ss_android_ugc_aweme_lancet_HashCodeLancet_hashCode */
    public static int m71105x6db40147(float f) {
