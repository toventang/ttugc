...
/* renamed from: com.ss.android.ugc.aweme.cr.d.a.a.c */
public final class C40343c extends AbstractC40342b {
    static {
    ...
    public final long mo69488b() {
        ...
        if (!(effectListModel == null || (effectPointModels = effectListModel.getEffectPointModels()) == null || !(!effectPointModels.isEmpty()))) {
            EffectListModel effectListModel2 = this.f94516a.f100882E;
            C89219l.m154716b(effectListModel2, "");
            ArrayList<EffectPointModel> effectPointModels2 = effectListModel2.getEffectPointModels();
            C89219l.m154716b(effectPointModels2, "");
            List f = C89070n.m154580f((Iterable) effectPointModels2);
