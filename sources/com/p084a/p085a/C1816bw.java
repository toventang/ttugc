...
public final class C1816bw implements AbstractC1876e {
    static {
    ...
    public final View mo5574a(Context context, ViewGroup viewGroup, boolean z) {
        ...
        viewStub.setId(R.id.efh);
        viewStub.setInflatedId(R.id.efg);
        viewStub.setLayoutResource(R.layout.a42);
        FrameLayout.LayoutParams layoutParams6 = new FrameLayout.LayoutParams(-1, -2);
        C0174a.m578a(viewStub);
        if (viewStub.getParent() == null) {
            frameLayout3.addView(viewStub, layoutParams6);
        }
        ...
        FrameLayout.LayoutParams layoutParams7 = new FrameLayout.LayoutParams(-1, (int) resources.getDimension(R.dimen.n5));
        ...
        if (DrawerLayout.C0844d.class.isInstance(layoutParams7)) {
            ((DrawerLayout.C0844d) layoutParams7).f3113a = 80;
        }
        C0174a.m578a(view2);
