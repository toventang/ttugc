...
/* renamed from: com.ss.android.ugc.aweme.legoImp.task.GsonPrewarmTask */
public final class GsonPrewarmTask implements AbstractC58264w {
    static {
    ...
    public final void mo28600a(Context context) {
        if (C41941b.m83979a() == 2 || C41941b.m83979a() == 4) {
            GsonProvider c = GsonHolder.m138943c();
            Iterator<T> it = DiscoveryServiceImpl.m83414g().mo70764c().iterator();
            while (it.hasNext()) {
                c.mo123619a(it.next());
            }
        }
