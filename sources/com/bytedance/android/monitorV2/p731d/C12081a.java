...
public final class C12081a extends AbstractC12066a {

    /* renamed from: a */
    public final List<Map<String, Object>> f28948a;

    static {
        Covode.recordClassIndex(13810);
    }

    public C12081a(List<Map<String, Object>> list) {
        C89219l.m154719c(list, "");
        this.f28948a = list;
    }

    public C12081a(Map<String, ? extends Object> map) {
        this(new ArrayList());
        if (map != null) {
            this.f28948a.add(map);
        }
    }
    ...
    public final void mo19417a(JSONObject jSONObject) {
        ...
        Iterator<T> it = this.f28948a.iterator();
        while (it.hasNext()) {
