...
public final class PollAdCardAction extends AbsAdCardAction implements AbstractC33974au, AbstractC90253j {

    /* renamed from: i */
    private ChooseLogAdExtraData f91776i;
    ...
    public final Map<Integer, Object> getSubscriberEventTypes() {
        ...
        subscriberEventTypes.put(238, new RunnableC90250g(PollAdCardAction.class, "userChooseEvent", ChooseLogAdExtraData.class, ThreadMode.POSTING, 0, false));
    ...
    public final void mo67489d() {
        ...
        C38661b.C38662a a = e.mo67229a(aweme).mo67231a(C38739d.m78577d(this.f91759c));
    ...
    public final void mo67491f() {
        ...
        String optString;
        mo67495j();
        C38661b.C38662a d = new C38661b.C38662a().mo67230a("close").mo67233b("card").mo67235d("vote");
        ChooseLogAdExtraData chooseLogAdExtraData = this.f91776i;
        String str = "before";
        ...
        C38661b.C38662a e = d.mo67236e(str);
        Aweme aweme = this.f91759c;
        C89219l.m154716b(aweme, "");
    ...
    public final void userChooseEvent(ChooseLogAdExtraData chooseLogAdExtraData) {
        ...
        this.f91776i = chooseLogAdExtraData;
    }
    ...
    public final void mo67485a(String str) {
        mo67495j();
        C38661b.C38662a d = new C38661b.C38662a().mo67230a("othershow_fail").mo67233b("card").mo67234c(String.valueOf(str)).mo67235d("vote");
        Aweme aweme = this.f91759c;
        C89219l.m154716b(aweme, "");
    ...
    public PollAdCardAction(Context context, Aweme aweme, AbstractC38878ae aeVar) {
