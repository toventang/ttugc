...
public final class C83744c extends AbstractC22219j implements AbstractC20382b, RepeatMusicPlayer.AbstractC70589a, AbstractC70604g.AbstractC70605a {

    /* renamed from: a */
    public static final C83745a f186912a = new C83745a((byte) 0);

    /* renamed from: b */
    private ShortVideoContext f186913b;

    /* renamed from: c */
    private AbstractC70604g f186914c;

    /* renamed from: d */
    private RepeatMusicPlayer f186915d;

    /* renamed from: e */
    private String f186916e;

    /* renamed from: f */
    private int f186917f;

    /* renamed from: g */
    private int f186918g;

    /* renamed from: h */
    private final AbstractC89172b<Integer, C89391z> f186919h;
    ...
    public static final class C83745a {
        static {
        ...
        public /* synthetic */ C83745a(byte b) {
            this();
        }
    }
    ...
    /* renamed from: a */
    private final void m144087a() {
        RepeatMusicPlayer repeatMusicPlayer = this.f186915d;
    ...
    public final void mo22713n_() {
        super.mo22713n_();
        AbstractC70604g gVar = this.f186914c;
        if (gVar != null) {
            gVar.mo111388a();
        }
    }
    ...
    public C83744c(AbstractC89172b<? super Integer, C89391z> bVar) {
    ...
    public final void mo88313e(int i) {
        this.f186918g = i;
        this.f186919h.invoke(Integer.valueOf(i));
        m144087a();
    }
    ...
    public final void mo88312d(int i) {
        String str = this.f186916e;
        if (str == null) {
            C89219l.m154710a("mMusicPath");
        }
        if (!TextUtils.isEmpty(str)) {
            this.f186918g = i;
            m144088a(i, this.f186917f);
        }
    }
    ...
    public final void mo22704a(Bundle bundle) {
        ...
        this.f186913b = shortVideoContext;
        ...
        if (shortVideoContext.f155817b.f155662r != null) {
            ...
            ShortVideoContext shortVideoContext2 = this.f186913b;
            ...
            ShortVideoContext shortVideoContext3 = this.f186913b;
        ...
        this.f186917f = i;
        ShortVideoContext shortVideoContext4 = this.f186913b;
        if (shortVideoContext4 == null) {
            C89219l.m154710a("shortVideoContext");
        }
        this.f186918g = shortVideoContext4.f155817b.f155661q;
        ShortVideoContext shortVideoContext5 = this.f186913b;
        ...
        ShortVideoContext shortVideoContext6 = this.f186913b;
        if (shortVideoContext6 == null) {
            C89219l.m154710a("shortVideoContext");
        }
        cVar3.f157965a = shortVideoContext6.f155811au;
        int i2 = this.f186917f;
        ShortVideoContext shortVideoContext7 = this.f186913b;
        if (shortVideoContext7 == null) {
            C89219l.m154710a("shortVideoContext");
        }
        cVar3.mo111387a(i2, shortVideoContext7.f155822g, this.f186918g);
        this.f186914c = cVar3;
        m144088a(this.f186918g, this.f186917f);
    }
    ...
    public final View mo22702a(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        View a = C1764a.m5927a(layoutInflater, R.layout.bi2, viewGroup, false);
        C89219l.m154716b(a, "");
        return a;
    }

    /* renamed from: a */
    private final void m144088a(int i, int i2) {
        String str = this.f186916e;
        if (str == null) {
            C89219l.m154710a("mMusicPath");
        }
        if (!TextUtils.isEmpty(str)) {
            if (this.f186915d == null) {
                ...
                String str2 = this.f186916e;
                if (str2 == null) {
                    C89219l.m154710a("mMusicPath");
                }
                this.f186915d = new RepeatMusicPlayer(bVar, str2, i2);
            }
            RepeatMusicPlayer repeatMusicPlayer = this.f186915d;
            if (repeatMusicPlayer == null) {
                C89219l.m154715b();
            ...
            RepeatMusicPlayer repeatMusicPlayer2 = this.f186915d;
