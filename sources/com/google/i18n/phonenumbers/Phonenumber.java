...
public final class Phonenumber {
    ...
    public static class PhoneNumber implements Serializable {
        ...
        public int hashCode() {
            int i;
            int countryCode = (((((getCountryCode() + 2173) * 53) + Long.valueOf(getNationalNumber()).hashCode()) * 53) + getExtension().hashCode()) * 53;
            int i2 = 1231;
