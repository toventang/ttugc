...
/* renamed from: com.a.a.cl */
public final class C1832cl implements AbstractC1876e {
    static {
    ...
    public final View mo5574a(Context context, ViewGroup viewGroup, boolean z) {
        ...
        View textureRenderView = new TextureRenderView(context);
        textureRenderView.setId(R.id.fe8);
        textureRenderView.setVisibility(8);
        ViewGroup.LayoutParams layoutParams9 = new FrameLayout.LayoutParams(-1, -1);
        C0174a.m578a(textureRenderView);
        if (textureRenderView.getParent() == null) {
            frameLayout3.addView(textureRenderView, layoutParams9);
        }
