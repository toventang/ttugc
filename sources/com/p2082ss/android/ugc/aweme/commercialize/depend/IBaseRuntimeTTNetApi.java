...
/* renamed from: com.ss.android.ugc.aweme.commercialize.depend.IBaseRuntimeTTNetApi */
public interface IBaseRuntimeTTNetApi {
    ...
    @AbstractC22000h
    AbstractC21983b<TypedInput> doGetForStream(@AbstractC21984a boolean z, @AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa(mo35781a = true) Map<String, String> map, @AbstractC22004l List<C22027b> list, @AbstractC21996d Object obj);
    ...
    @AbstractC21991ae
    @AbstractC22001i
    AbstractC21983b<String> doHead(@AbstractC21984a boolean z, @AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa(mo35781a = true) Map<String, String> map, @AbstractC22004l List<C22027b> list, @AbstractC21996d Object obj);
    ...
    @AbstractC22012t
    @AbstractC21999g
    AbstractC21983b<TypedInput> doPostForStream(@AbstractC21984a boolean z, @AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa Map<String, String> map, @AbstractC22004l List<C22027b> list, @AbstractC21998f(mo35788a = true) Map<String, String> map2, @AbstractC21996d Object obj);
