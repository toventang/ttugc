...
/* renamed from: com.ss.android.ugc.aweme.compliance.privacy.settings.account.pages.suggestaccount.SugToMutualConnectionsViewModel */
public final class SugToMutualConnectionsViewModel extends BasePrivacyUserSettingViewModel implements AbstractC90253j {
    static {
    ...
    public final AbstractC88979t<BaseResponse> mo69142b(int i) {
        return C39727a.m80621c("to_mutual_connections", i);
    }
    ...
    public final Integer mo69143a(C39258q qVar) {
        ...
        if (tVar != null) {
            return Integer.valueOf(tVar.f92754c);
        }
        return null;
    }
