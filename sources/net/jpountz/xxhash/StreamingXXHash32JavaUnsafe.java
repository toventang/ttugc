...
final class StreamingXXHash32JavaUnsafe extends AbstractStreamingXXHash32Java {
    ...
    public final void update(byte[] bArr, int i, int i2) {
        ...
        if (this.memSize > 0) {
            ...
            this.f203845v1 += UnsafeUtils.readIntLE(this.memory, 0) * -2048144777;
            this.f203845v1 = Integer.rotateLeft(this.f203845v1, 13);
            this.f203845v1 *= -1640531535;
            this.f203846v2 += UnsafeUtils.readIntLE(this.memory, 4) * -2048144777;
            this.f203846v2 = Integer.rotateLeft(this.f203846v2, 13);
            this.f203846v2 *= -1640531535;
            this.f203847v3 += UnsafeUtils.readIntLE(this.memory, 8) * -2048144777;
            this.f203847v3 = Integer.rotateLeft(this.f203847v3, 13);
            this.f203847v3 *= -1640531535;
            this.f203848v4 += UnsafeUtils.readIntLE(this.memory, 12) * -2048144777;
