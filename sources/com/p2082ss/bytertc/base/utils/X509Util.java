...
/* renamed from: com.ss.bytertc.base.utils.X509Util */
public class X509Util {
    ...
    /* renamed from: com.ss.bytertc.base.utils.X509Util$1 */
    public static /* synthetic */ class C860771 {
        static {
            Covode.recordClassIndex(100871);
        }
    }

    /* renamed from: com.ss.bytertc.base.utils.X509Util$Natives */
    interface Natives {
        static {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: com.ss.bytertc.base.utils.X509Util$X509TrustManagerImplementation */
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: com.ss.bytertc.base.utils.X509Util$TrustStorageListener */
    public static final class TrustStorageListener extends BroadcastReceiver {
        ...
        /* synthetic */ TrustStorageListener(C860771 r1) {
            this();
        }
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                LogUtil.m147887e("X509Util", "Unable to reload the default TrustManager", e);
            } catch (KeyStoreException e2) {
                LogUtil.m147887e("X509Util", "Unable to reload the default TrustManager", e2);
            } catch (NoSuchAlgorithmException e3) {
                LogUtil.m147887e("X509Util", "Unable to reload the default TrustManager", e3);
            }
        }
    }
    ...
    public static void clearTestRootCertificates() {
        /*
            r3 = 2622(0xa3e, float:3.674E-42)
            com.bytedance.frameworks.apm.trace.MethodCollector.m26663i(r3)
            ensureInitialized()
            java.lang.Object r2 = com.p2082ss.bytertc.base.utils.X509Util.sLock
            monitor-enter(r2)
            java.security.KeyStore r1 = com.p2082ss.bytertc.base.utils.X509Util.sTestKeyStore     // Catch:{ IOException -> 0x0014 }
            r0 = 0
        ...
        L_0x0019:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p2082ss.bytertc.base.utils.X509Util.clearTestRootCertificates():void");
    }

    private static void ensureInitialized() {
        MethodCollector.m26663i(2284);
        synchronized (sLock) {
            try {
                ensureInitializedLocked();
            } finally {
                MethodCollector.m26664o(2284);
            }
        }
    }

    public static void reloadDefaultTrustManager() {
        MethodCollector.m26663i(2453);
        synchronized (sLock) {
            try {
    ...
    private static void ensureInitializedLocked() {
        ...
        if (sTrustStorageListener == null) {
            ...
            m147861xc1057fe7(ContextUtils.getApplicationContext(), sTrustStorageListener, intentFilter);
        }
    }
    ...
    /* renamed from: com.ss.bytertc.base.utils.X509Util$X509TrustManagerIceCreamSandwich */
    static final class X509TrustManagerIceCreamSandwich implements X509TrustManagerImplementation {
        ...
        @Override // com.p2082ss.bytertc.base.utils.X509Util.X509TrustManagerImplementation
        public final List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) {
            try {
                ...
                LogUtil.m147887e("X509Util", "X509TrustManager unexpectedly threw: %s", e);
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: com.ss.bytertc.base.utils.X509Util$X509TrustManagerJellyBean */
    public static final class X509TrustManagerJellyBean implements X509TrustManagerImplementation {
        ...
        public final List<X509Certificate> checkServerTrusted(X509Certificate[] x509CertificateArr, String str, String str2) {
            try {
                ...
                LogUtil.m147887e("X509Util", "checkServerTrusted() unexpectedly threw: %s", e);
                throw new CertificateException(e);
            }
        }
    }
    ...
    static boolean verifyKeyUsage(java.security.cert.X509Certificate r5) {
        ...
        L_0x003a:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p2082ss.bytertc.base.utils.X509Util.verifyKeyUsage(java.security.cert.X509Certificate):boolean");
    }
            ...
            for (TrustManager trustManager : trustManagers) {
                if (trustManager instanceof X509TrustManager) {
                    try {
                        ...
                        LogUtil.m147886e("X509Util", "Error creating trust manager (" + trustManager.getClass().getName() + "): " + e);
                    }
                }
            }
            LogUtil.m147886e("X509Util", "Could not find suitable trust manager");
            return null;
        } catch (RuntimeException e2) {
            LogUtil.m147887e("X509Util", "TrustManagerFactory.getTrustManagers() unexpectedly threw: %s", e2);
        ...
        while (true) {
            ...
            if (certificate != null) {
                if (!(certificate instanceof X509Certificate)) {
                    LogUtil.m147886e("X509Util", "Anchor " + str + " not an X509Certificate: " + certificate.getClass().getName());
                } else {
    ...
    /* renamed from: com_ss_bytertc_base_utils_X509Util_com_bytedance_sysoptimizer_ReceiverRegisterLancet_registerReceiver */
    public static Intent m147860x324b8ac3(Context context, BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        try {
    ...
    /* renamed from: com_ss_bytertc_base_utils_X509Util_com_ss_android_ugc_aweme_lancet_receiver_ReceiverRegisterLancet_registerReceiver */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.content.Intent m147861xc1057fe7(android.content.Context r1, android.content.BroadcastReceiver r2, android.content.IntentFilter r3) {
        /*
            android.app.Application r0 = com.bytedance.ies.ugc.appcontext.C17879g.m33104a()
            com.p2082ss.android.ugc.aweme.lancet.receiver.C58039a.m104863a(r0)
            android.content.Intent r0 = m147860x324b8ac3(r1, r2, r3)     // Catch:{ Exception -> 0x000c }
            return r0
        L_0x000c:
        ...
        L_0x0027:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.p2082ss.bytertc.base.utils.X509Util.m147861xc1057fe7(android.content.Context, android.content.BroadcastReceiver, android.content.IntentFilter):android.content.Intent");
    }

    public static AndroidCertVerifyResult verifyServerCertificates(byte[][] bArr, String str, String str2) {
        List<X509Certificate> list;
        boolean z;
        MethodCollector.m26663i(2708);
            ...
            try {
                ...
                for (int i = 1; i < bArr.length; i++) {
                    try {
                        ...
                        LogUtil.m147889w("X509Util", "intermediate " + i + " failed parsing");
                    }
                }
                        ...
                        try {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    LogUtil.m147888i("X509Util", "Failed to validate the certificate chain, error: " + e.getMessage());
                            ...
                            AndroidCertVerifyResult androidCertVerifyResult3 = new AndroidCertVerifyResult(0, z, list);
                            MethodCollector.m26664o(2708);
