...
/* renamed from: com.bytedance.android.ecommerce.f.l */
public final class C2797l implements AbstractC2800a {
    static {
    ...
    public final C2744d mo7383a(C2743c... cVarArr) {
        ...
        if (cVar.mo7324a() && TextUtils.isEmpty(str)) {
            dVar.f8231a = false;
            dVar.mo7327a("pipo_common_error_required_field", "pipo_common_payin_address");
        }
        return dVar;
    }
}
