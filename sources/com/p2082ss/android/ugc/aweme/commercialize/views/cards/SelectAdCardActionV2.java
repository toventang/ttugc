...
/* renamed from: com.ss.android.ugc.aweme.commercialize.views.cards.SelectAdCardActionV2 */
public final class SelectAdCardActionV2 extends AbsAdCardActionV2 implements AbstractC33974au, AbstractC90253j {

    /* renamed from: i */
    private ChooseLogAdExtraData f91779i;
    ...
    public final Map<Integer, Object> getSubscriberEventTypes() {
        ...
        subscriberEventTypes.put(238, new RunnableC90250g(SelectAdCardActionV2.class, "userChooseEvent", ChooseLogAdExtraData.class, ThreadMode.POSTING, 0, false));
    ...
    public final void mo67502d() {
        ...
        String d;
        mo67506j();
        C38661b.C38662a d2 = new C38661b.C38662a().mo67230a("othershow").mo67233b("card").mo67235d("choose");
    ...
    public final void mo67491f() {
        ...
        ChooseLogAdExtraData chooseLogAdExtraData = this.f91779i;
        String str2 = "choose";
        ...
        C38661b.C38662a d2 = b.mo67235d(str2);
        AbstractC37687t a = C37663b.f89031b.mo65688a();
        if (!(a == null || (d = a.mo65668d(this.f91766c)) == null)) {
            str = d;
        }
        C38661b.C38662a f = d2.mo67237f(str);
        AbstractC37687t a2 = C37663b.f89031b.mo65688a();
        if (a2 != null) {
            j = a2.mo65670e(this.f91766c);
        } else {
            j = 0;
        }
        mo67498a(f.mo67228a(j).mo67232a());
    ...
    public final void userChooseEvent(ChooseLogAdExtraData chooseLogAdExtraData) {
        ...
        this.f91779i = chooseLogAdExtraData;
    }
    ...
    public final void mo67499a(String str) {
        ...
        String d;
        mo67506j();
        C38661b.C38662a d2 = new C38661b.C38662a().mo67230a("othershow_fail").mo67233b("card").mo67234c(String.valueOf(str)).mo67235d("choose");
        Aweme aweme = this.f91766c;
        String str2 = "";
    ...
    public SelectAdCardActionV2(Context context, Aweme aweme, AbstractC38878ae aeVar) {
