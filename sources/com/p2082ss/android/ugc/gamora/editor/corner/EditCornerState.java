...
/* renamed from: com.ss.android.ugc.gamora.editor.corner.EditCornerState */
public final class EditCornerState extends UiState {
    ...
    /* renamed from: ui */
    private final AbstractC23517a f183667ui;
    ...
    public static /* synthetic */ EditCornerState copy$default(EditCornerState editCornerState, Boolean bool, Integer num, Integer num2, AbstractC23517a aVar, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final EditCornerState copy(Boolean bool, Integer num, Integer num2, AbstractC23517a aVar) {
    ...
    public final boolean equals(Object obj) {
        ...
        return C89219l.m154714a(this.cornerVisible, editCornerState.cornerVisible) && C89219l.m154714a(this.topMargin, editCornerState.topMargin) && C89219l.m154714a(this.bottomMargin, editCornerState.bottomMargin) && C89219l.m154714a(getUi(), editCornerState.getUi());
    }
    ...
    public final AbstractC23517a getUi() {
        return this.f183667ui;
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public EditCornerState(Boolean bool, Integer num, Integer num2, AbstractC23517a aVar) {
        super(aVar);
        C89219l.m154721d(aVar, "");
    ...
    public /* synthetic */ EditCornerState(Boolean bool, Integer num, Integer num2, AbstractC23517a aVar, int i, C89214g gVar) {
