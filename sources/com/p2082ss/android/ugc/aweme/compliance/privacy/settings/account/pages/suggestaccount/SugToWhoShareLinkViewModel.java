...
/* renamed from: com.ss.android.ugc.aweme.compliance.privacy.settings.account.pages.suggestaccount.SugToWhoShareLinkViewModel */
public final class SugToWhoShareLinkViewModel extends BasePrivacyUserSettingViewModel implements AbstractC90253j {
    static {
    ...
    public final AbstractC88979t<BaseResponse> mo69142b(int i) {
        return C39727a.m80621c("to_who_share_link", i);
    }
    ...
    public final Integer mo69143a(C39258q qVar) {
        ...
        if (tVar != null) {
            return Integer.valueOf(tVar.f92755d);
        }
        return null;
    }
