...
final class StreamingXXHash64JavaSafe extends AbstractStreamingXXHash64Java {
    ...
    public final void update(byte[] bArr, int i, int i2) {
        ...
        if (this.memSize > 0) {
            ...
            this.f203849v1 += SafeUtils.readLongLE(this.memory, 0) * -4417276706812531889L;
            this.f203849v1 = Long.rotateLeft(this.f203849v1, 31);
            this.f203849v1 *= -7046029288634856825L;
            this.f203850v2 += SafeUtils.readLongLE(this.memory, 8) * -4417276706812531889L;
            this.f203850v2 = Long.rotateLeft(this.f203850v2, 31);
            this.f203850v2 *= -7046029288634856825L;
            this.f203851v3 += SafeUtils.readLongLE(this.memory, 16) * -4417276706812531889L;
            this.f203851v3 = Long.rotateLeft(this.f203851v3, 31);
            this.f203851v3 *= -7046029288634856825L;
            this.f203852v4 += SafeUtils.readLongLE(this.memory, 24) * -4417276706812531889L;
        ...
        long j5 = this.f203852v4;
        while (i3 <= i5) {
            j2 = Long.rotateLeft(j2 + (SafeUtils.readLongLE(bArr, i3) * j), 31) * -7046029288634856825L;
            int i6 = i3 + 8;
            ...
            int i8 = i7 + 8;
            j5 = Long.rotateLeft(j5 + (SafeUtils.readLongLE(bArr, i8) * -4417276706812531889L), 31) * -7046029288634856825L;
            i3 = i8 + 8;
