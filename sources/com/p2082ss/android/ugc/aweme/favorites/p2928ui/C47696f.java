...
import com.p2082ss.android.ugc.aweme.favorites.model.C47474e;
...
public class C47696f extends AbstractC47599a implements AbstractC90252i, AbstractC90253j {
    static {
    ...
    public Map<Integer, Object> getSubscriberEventTypes() {
        ...
        hashMap.put(34, new RunnableC90250g(C47696f.class, "onAntiCrawlerEvent", C34569a.class, ThreadMode.POSTING, 0, false));
        return hashMap;
    }
    ...
    public final void mo79781l() {
        if (this.f110455j != null) {
            this.f110455j.mo67838a((AbstractC39085b) new C47474e());
        }
    }
    ...
    public final AbstractC39060f mo79782n() {
        if (getActivity() != null) {
            return new C47179b(getActivity(), this);
        }
        return null;
    }
    ...
    public final void mo79785q() {
        ...
        aVar.f54431a = R.raw.icon_large_comment;
        aVar.f54435e = Integer.valueOf((int) R.attr.bd);
        this.f110451b.setStatus(new TuxStatusView.C23263c().mo37877a(aVar).mo37879a(getString(R.string.bs0)).mo37878a((CharSequence) getString(R.string.brz)));
    ...
    public final void mo59512a(List list, boolean z) {
        ...
        if (this.f110455j.f92286h instanceof C47474e) {
            C47474e eVar = (C47474e) this.f110455j.f92286h;
            if (eVar.mData == null) {
                i = 0;
            } else {
                i = ((C47472c) eVar.mData).f110286d;
            }
            ActivityC0945e activity = getActivity();
            if (i != 0 && activity != null) {
                new C23144b(this).mo37635a(activity.getString(R.string.di2, Integer.valueOf(i))).mo37637b();
            }
        }
    }
}
