...
public final class LZ4HCJavaUnsafeCompressor extends LZ4Compressor {
    ...
    public class HashTable {
        ...
        public boolean insertAndFindBestMatch(byte[] bArr, int i, int i2, LZ4Utils.Match match) {
            ...
            if (hashPointer < i - 4 || hashPointer > i || hashPointer < this.base) {
                ...
                if (LZ4UnsafeUtils.readIntEquals(bArr, hashPointer, i)) {
                    i3 = i - hashPointer;
                    i4 = LZ4UnsafeUtils.commonBytes(bArr, hashPointer + 4, i + 4, i2) + 4;
                    match.len = i4;
                    match.ref = hashPointer;
                } else {
                    i3 = 0;
        ...
        public boolean insertAndFindWiderMatch(byte[] bArr, int i, int i2, int i3, int i4, LZ4Utils.Match match) {
            ...
            int hashPointer = hashPointer(bArr, i);
            for (int i5 = 0; i5 < LZ4HCJavaUnsafeCompressor.this.maxAttempts && hashPointer >= Math.max(this.base, (i - 65536) + 1) && hashPointer <= i; i5++) {
                if (LZ4UnsafeUtils.readIntEquals(bArr, hashPointer, i) && (commonBytes = LZ4UnsafeUtils.commonBytes(bArr, hashPointer + 4, i + 4, i3) + 4 + (commonBytesBackward = LZ4UnsafeUtils.commonBytesBackward(bArr, hashPointer, i, this.base, i2))) > match.len) {
                    match.len = commonBytes;
                    match.ref = hashPointer - commonBytesBackward;
                    match.start = i - commonBytesBackward;
                }
    ...
    public final int compress(byte[] bArr, int i, int i2, byte[] bArr2, int i3, int i4) {
        int i5 = i;
        UnsafeUtils.checkRange(bArr, i5, i2);
            ...
            if (!hashTable.insertAndFindBestMatch(bArr, i10, i9, match2)) {
                ...
                while (true) {
                    if (match2.end() >= i8 || !hashTable.insertAndFindWiderMatch(bArr, match2.end() - 2, match2.start + 1, i9, match2.len, match3)) {
                        i11 = LZ4UnsafeUtils.encodeSequence(bArr, i5, match2.start, match2.ref, match2.len, bArr2, i11, i7);
                        i5 = match2.end();
                        i10 = i5;
                    } else {
                ...
                i11 = LZ4UnsafeUtils.encodeSequence(bArr, match2.end(), match3.start, match3.ref, match3.len, bArr2, LZ4UnsafeUtils.encodeSequence(bArr, i5, match2.start, match2.ref, match2.len, bArr2, i11, i7), i7);
                i5 = match3.end();
                i10 = i5;
            }
        }
        return LZ4UnsafeUtils.lastLiterals(bArr, i5, i6 - i5, bArr2, i11, i7) - i3;
    }
