...
/* renamed from: com.ss.android.ugc.aweme.share.improve.a.ap */
public final class C69003ap implements AbstractC69693h {

    /* renamed from: a */
    private final C66289b f154348a;
    ...
    public final void mo61915a(Context context, SharePackage sharePackage) {
        ...
        if (TextUtils.isEmpty(this.f154348a.f149022a)) {
            str = "0";
        } else {
            str = this.f154348a.f149022a;
        }
        C39223a.m79587a().mo68688a(C69124b.m122223a(context), new Uri.Builder().appendQueryParameter("report_type", "ques_ans").appendQueryParameter("object_id", String.valueOf(this.f154348a.f149023b)).appendQueryParameter("owner_id", str));
        C39223a.m79587a().mo68691a("qa_detail", "ques_ans", "", String.valueOf(this.f154348a.f149023b), this.f154348a.f149022a, "", "click_share_button");
    }
}
