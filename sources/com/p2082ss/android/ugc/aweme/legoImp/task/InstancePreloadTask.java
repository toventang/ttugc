...
/* renamed from: com.ss.android.ugc.aweme.legoImp.task.InstancePreloadTask */
public final class InstancePreloadTask implements AbstractC58084a, AbstractC58264w {
    static {
    ...
    public final void mo28600a(Context context) {
        if (((Boolean) C46714av.f108880a.getValue()).booleanValue()) {
            try {
                Class.forName("com.ss.android.ugc.aweme.ca.c");
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
