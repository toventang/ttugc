...
/* renamed from: ms.bd.o.n0 */
public final class C89914n0 extends C89868b.AbstractC89869a {
    static {
    ...
    public final Object mo35029a(long j, String str, Object obj) {
        String str2;
        MethodCollector.m26663i(521);
        try {
            Locale locale = C89865a.f203764a.f203765b.getResources().getConfiguration().locale;
            str2 = locale.getLanguage() + ((String) C89889h.m155966a(16777217, 0, 0, "cb19f9", new byte[]{77})) + locale.getCountry();
        } catch (Throwable unused) {
            str2 = null;
        }
        String a = C89959z1.m156087a(str2);
        MethodCollector.m26664o(521);
        return a;
    }
}
