...
public interface IIESNetworkApi {
    ...
    @AbstractC21995c
    AbstractC21983b<String> doDetete(@AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa Map<String, String> map, @AbstractC22004l List<C22027b> list, @AbstractC21996d Object obj);
    ...
    @AbstractC21999g
    @AbstractC22013u
    AbstractC21983b<String> doPut(@AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa Map<String, String> map, @AbstractC21998f(mo35788a = true) Map<String, String> map2, @AbstractC22004l List<C22027b> list, @AbstractC21996d Object obj);
    ...
    @AbstractC22000h
    @AbstractC21991ae
    AbstractC21983b<TypedInput> downloadFile(@AbstractC21984a boolean z, @AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa(mo35781a = true) Map<String, String> map, @AbstractC22004l List<C22027b> list);
    ...
    @AbstractC22012t
    @AbstractC22009q
    AbstractC21983b<String> postMultiPart(@AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa(mo35781a = true) Map<String, String> map, @AbstractC22015w Map<String, TypedOutput> map2, @AbstractC22004l List<C22027b> list, @AbstractC21996d Object obj);

    @AbstractC22013u
    AbstractC21983b<String> putBody(@AbstractC22007o int i, @AbstractC21993ag String str, @AbstractC21987aa(mo35781a = true) Map<String, String> map, @AbstractC21994b TypedOutput typedOutput, @AbstractC22004l List<C22027b> list, @AbstractC21996d Object obj);
}
