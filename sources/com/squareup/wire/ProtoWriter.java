...
public final class ProtoWriter {
    private final AbstractC89425g sink;
    ...
    public ProtoWriter(AbstractC89425g gVar) {
        this.sink = gVar;
    }

    public final void writeBytes(C89427i iVar) {
        this.sink.mo68850a(iVar);
    }

    public final void writeFixed32(int i) {
        this.sink.mo68860d(i);
    }

    public final void writeFixed64(long j) {
        this.sink.mo68848a(j);
    }

    public final void writeString(String str) {
        this.sink.mo68849a(str);
    }
    ...
    public final void writeVarint32(int i) {
        while ((i & -128) != 0) {
            this.sink.mo68847a((i & 127) | 128);
            i >>>= 7;
        }
        this.sink.mo68847a(i);
    }

    public final void writeVarint64(long j) {
        while ((-128 & j) != 0) {
            this.sink.mo68847a((((int) j) & 127) | 128);
            j >>>= 7;
        }
        this.sink.mo68847a((int) j);
    }
