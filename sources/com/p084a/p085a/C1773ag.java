...
public final class C1773ag implements AbstractC1876e {
    static {
    ...
    public final View mo5574a(Context context, ViewGroup viewGroup, boolean z) {
        MethodCollector.m26663i(587);
        context.getResources();
        FrameLayout frameLayout = new FrameLayout(context);
        frameLayout.setId(R.id.b11);
        ViewGroup.MarginLayoutParams a = C0174a.m576a(viewGroup, -1, -1);
        View a2 = C1862a.m6033a(context, R.layout.s2, frameLayout, false, R.layout.s1);
        ...
        View a3 = C1862a.m6033a(context, R.layout.sm, frameLayout, false, R.layout.s1);
