...
/* renamed from: com.bytedance.android.livesdk.manage.c.d */
public final class C9488d extends AbstractC9484a {
    static {
    ...
    public final void mo16302a(int i) {
        ...
        for (AssetsModel assetsModel : C9462a.C9465b.f23010a.f23004a) {
            if (((double) (currentTimeMillis - C10310r.m18754a(assetsModel.getId()))) > this.f23031a && (assetsModel.getResourceType() == 1 || assetsModel.getResourceType() == 2)) {
