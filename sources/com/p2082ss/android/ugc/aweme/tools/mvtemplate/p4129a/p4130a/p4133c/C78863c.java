...
/* renamed from: com.ss.android.ugc.aweme.tools.mvtemplate.a.a.c.c */
public final class C78863c extends AbstractC78851a {
    static {
        Covode.recordClassIndex(92012);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C78863c(C78859b bVar) {
        super(bVar);
    ...
    public final void mo122701a(Object obj) {
        ...
        if (this.f177240c.f177257n == null || TextUtils.isEmpty(this.f177240c.f177256m) || !C84902i.m145892a(this.f177240c.f177256m)) {
        ...
        long a3 = this.f177239b.mo122711a("use shoot same music cache", "success");
        C78899d dVar3 = this.f177240c.f177249f;
        if (dVar3 != null) {
            dVar3.f177324g = (int) a3;
        }
        AbstractC78852b bVar3 = this.f177240c.f177252i;
        if (bVar3 != null) {
            MusicModel musicModel2 = this.f177240c.f177257n;
            if (musicModel2 == null) {
                C89219l.m154715b();
            }
            String str2 = this.f177240c.f177256m;
            if (str2 == null) {
                C89219l.m154715b();
            }
            bVar3.mo122695a(musicModel2, str2, true);
        }
    }
}
