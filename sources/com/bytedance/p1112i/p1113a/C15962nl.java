...
/* renamed from: com.bytedance.i.a.nl */
public class C15962nl extends AbstractC15287a {
    static {
    ...
    public final void mo24794a() {
        ...
        this.f37302c.close();
        this.f37302c.moveTo(12.1094f, 18.6641f);
        this.f37302c.lineTo(21.0f, 12.737f);
        this.f37302c.lineTo(21.0f, 35.263f);
        this.f37302c.lineTo(12.1094f, 29.3359f);
        this.f37302c.cubicTo(11.7809f, 29.1169f, 11.3948f, 29.0f, 11.0f, 29.0f);
        this.f37302c.lineTo(7.0f, 29.0f);
        this.f37302c.lineTo(7.0f, 19.0f);
        this.f37302c.lineTo(11.0f, 19.0f);
        this.f37302c.cubicTo(11.3948f, 19.0f, 11.7809f, 18.8831f, 12.1094f, 18.6641f);
        this.f37302c.close();
