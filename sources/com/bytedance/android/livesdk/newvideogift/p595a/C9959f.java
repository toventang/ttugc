...
/* renamed from: com.bytedance.android.livesdk.newvideogift.a.f */
public class C9959f implements AbstractC86253m {

    /* renamed from: e */
    private static boolean f24136e;
    ...
    /* renamed from: d */
    private AbstractC86265n f24139d;
    ...
    public final boolean mo16707a() {
        AbstractC86265n nVar = this.f24139d;
    ...
    public final void mo16691a(Surface surface) {
        ...
        if ((surface == null || surface.isValid()) && (nVar = this.f24139d) != null) {
    ...
    /* renamed from: a */
    public static AbstractC86253m m18299a(Context context) {
        MethodCollector.m26663i(4913);
        C9959f fVar = new C9959f();
        synchronized (C9959f.class) {
            try {
                if (C86277r.m148507a()) {
                    try {
                        ...
                        fVar.f24139d = (AbstractC86265n) declaredMethod.invoke(cls, fVar, context);
                        f24136e = true;
                    } catch (Throwable th) {
                        fVar.f24137a = true;
                        fVar.f24138b = th.toString();
                    }
                    if (fVar.f24139d == null) {
                        try {
                            ...
                            fVar.f24139d = (AbstractC86265n) declaredMethod2.invoke(cls2, fVar, context);
                        } catch (Throwable th2) {
                            fVar.f24137a = true;
                            fVar.f24138b = th2.toString();
                        }
                    }
                }
                if (fVar.f24139d == null) {
                    fVar.f24139d = C86266o.m148462a(fVar);
                }
            } finally {
                MethodCollector.m26664o(4913);
            }
        }
        return fVar;
    }
