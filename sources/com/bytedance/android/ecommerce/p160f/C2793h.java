...
/* renamed from: com.bytedance.android.ecommerce.f.h */
public final class C2793h implements AbstractC2800a {
    static {
    ...
    public final C2744d mo7383a(C2743c... cVarArr) {
        ...
        if (cVar.mo7324a() && TextUtils.isEmpty(str)) {
            dVar.f8231a = false;
            dVar.mo7327a("pipo_common_error_required_field", "pipo_common_payin_cardholder_name");
        } else if (!Pattern.matches("^[\\p{sc=Latin}\\s.-]*$", str)) {
            dVar.f8231a = false;
            dVar.mo7327a("pipo_common_error_is_invalid", "pipo_common_payin_cardholder_name");
        }
        return dVar;
    }
}
